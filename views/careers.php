...
<div style="margin-top: -7vh" class="text-white min-h-screen">
    ...
    <div class="relative min-h-screen flex items-center justify-center text-center">
        ...
        <div class="relative z-10">
            <h1 class="text-5xl font-bold text-white">Careers at Navocloud</h1>
            <p class="text-xl text-gray-300 mt-4">We're always looking for talented people to join us here at Navocloud.</p>
            <div class="flex items-center justify-center space-x-4 mt-6">
                <a href="#open-positions" class="bg-red-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-red-600 transition">Open Positions</a>
                <a href="#benefits" class="border border-white px-6 py-3 rounded-lg font-semibold text-white hover:bg-gray-700 transition">Our Benefits</a>
            </div>
        </div>
    </div>
...
<section id="open-positions" class="px-8 py-12">
    ...
    <div class="space-y-6">
        <!-- Job Item -->
        <div style="border: 2px solid blue" class="flex items-center justify-between p-6 rounded-lg">
            <div>
                <h3 class="text-2xl font-semibold">Website Developer</h3>
                <span class="text-gray-400">Junior - Mid</span>
            </div>
            <a href="/careers/apply#webdev" class="bg-blue-500 px-4 py-2 rounded-lg text-white font-semibold hover:bg-blue-600">Learn more</a>
        </div>
        <div style="border: 2px solid blue" class="flex items-center justify-between p-6 rounded-lg">
            <div>
            ...
            <a href="/careers/apply#sysadmin" class="bg-blue-500 px-4 py-2 rounded-lg text-white font-semibold hover:bg-blue-600">Learn more</a>
        </div>
        <div style="border: 2px solid blue" class="flex items-center justify-between p-6 rounded-lg">
            <div>
            ...
            <a href="/careers/apply#admin" class="bg-blue-500 px-4 py-2 rounded-lg text-white font-semibold hover:bg-blue-600">Learn more</a>
        </div>
        <div style="border: 2px solid blue" class="flex items-center justify-between p-6 rounded-lg">
            <div>
            ...
            <a href="/careers/apply#mod" class="bg-blue-500 px-4 py-2 rounded-lg text-white font-semibold hover:bg-blue-600">Learn more</a>
        </div>
        <!-- Other -->
        <div class="text-center mt-8">
            <p class="text-lg">Have something to offer that we don’t have an open position for?</p>
            <a href="/careers/apply" class="bg-blue-500 px-4 py-2 mt-4 inline-block rounded-lg text-white font-semibold hover:bg-blue-600">Apply</a>
        </div>
    </div>
</section>
